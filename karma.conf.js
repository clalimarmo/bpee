...
module.exports = function(config) {
  config.set({
    ...
    files: [
      ...
      {pattern: 'spec/helpers/*.coffee', included: false},
    ...
    exclude: [
      '**/*.swp',
      'build/lib/**/test/**/*js', //DO NOT run tests for third party libraries
    ],
    ...
    preprocessors: {
      'build/{models,views,collections,services,util}/*.js': ['coverage'],
      'spec/**/*.coffee': ['coffee'],
    },
